...
<div class="shopList comWidth clearfix">
	...
	<div class="rightArea">
		...
		?>
			<div class="shop_item">
				<div class="shop_img">
					<a href="#"><img height="200" width="187" src="test/uploads/image_220/<?php echo $proImg['albumPath'];?>" alt=""></a>
				</div>
		...
		<div class="shopList_sm clearfix">
			...
			<div class="shopItem_sm">
				<div class="shopItem_smImg">
					<a href="#"><img height="95" width="95" src="test/uploads/image_220/<?php echo $proImgSmall['albumPath'];?>" alt=""></a>
				</div>
