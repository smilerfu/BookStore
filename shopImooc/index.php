...
require_once(dirname(__FILE__).'/core/album.inc.php');
require_once(dirname(__FILE__).'/lib/common.func.php');
$cates = getAllCate();
if(!($cates && is_array($cates)))
{
	echo "没有分类数据";
	alertMes("网站维护中，请稍后再试", "http://www.baidu.com");
}
?>
...
<div class="shopList comWidth clearfix">
	...
	<div class="rightArea">
		<div class="shopList_top clearfix">
			<?php 
			$pros = getProsByCid($cate['id'], 4);
			foreach ($pros as $pro):
			$proImg = getProImgById($pro['id']);
			?>
			<div class="shop_item">
				<div class="shop_img">
					<a href="proDetails.php?id=<?php echo $pro['id'];?>" target="_blank"><img height="200" width="187" src="test/uploads/image_220/<?php echo $proImg['albumPath'];?>" alt=""></a>
				</div>
		...
		<div class="shopList_sm clearfix">
			<?php 
			$prosSmall = getProsByCid($cate['id'], 4, 4);
			foreach ($prosSmall as $proSmall):
			$proImgSmall = getProImgById($proSmall['id']);
			?>
			<div class="shopItem_sm">
				<div class="shopItem_smImg">
					<a href="proDetails.php?id=<?php echo $proSmall['id'];?>" target="_blank"><img height="95" width="95" src="test/uploads/image_220/<?php echo $proImgSmall['albumPath'];?>" alt=""></a>
				</div>
