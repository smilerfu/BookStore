...
<div class="regBox">
	...
	<form method="post" enctype="multipart/form-data" action="doAction.php?act=reg">
		<ul class="login">
			...
			<li><span class="reg_item"><i>*</i>邮箱：</span><div class="input_item"><input type="text" name="email" placeholder="请输入邮箱" class="login_input user_icon"></div></li>
			<li><span class="reg_item"><i>*</i>性别：</span><div class="input_item">
			<input type="radio" checked="checked" name="sex" value="0">男
			<input type="radio" name="sex" value="1">女
			<input type="radio" name="sex" value="2">保密</div></li>
